...
import { createPaymentRepo, updatePaymentByIdRepo } from "../repository/paymentRepo.js";
import { createReqRepo, getMyReqRepo, getRequestRepo, getRequestsRepo, linkPaymentToReqRepo, updateStatusRepo } from "../repository/requestRepo.js"
...
export const createReqService= async (reqDetails)=>{
    ...
    await updatePaymentByIdRepo(payment._id,{razopayOrderId:order.id});
